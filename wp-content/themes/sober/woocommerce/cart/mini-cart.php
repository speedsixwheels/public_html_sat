						...
						<div class="row">
							<div class="product-title col-sm-5 col-md-5">
								...
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s"><svg viewBox="0 0 12 12"><use xlink:href="#close-delete-small"></use></svg></a>',
								...
								<?php else : ?>
									<a href="<?php echo esc_url( $product_permalink ); ?>">
										<?php
										echo '' . $thumbnail;
										echo '<span class="product-cart-data">';
